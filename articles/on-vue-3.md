...
### Mixins
Fortunately or not, mixins are becoming less popular thanks to the [Composables](https://vuejs.org/guide/reusability/composables.html). However, mixins are a real pain to work with. Don't believe me? Try to understand how this component works - https://github.com/bootstrap-vue/bootstrap-vue/blob/dev/src/components/carousel/carousel.js 
